      ...
      <div class="movie-card">
        ...
        <div class="movie-details">
          ...
          <p>
            ...
            {{ pelicula ? pelicula.genero : "Desconocido" }}
          </p>
          <p>
            <strong>Año:</strong> {{ pelicula ? pelicula.año : "Desconocido" }}
          </p>
          <p>
            <strong>Duración:</strong>
            {{ pelicula ? pelicula.duracion + " minutos" : "Desconocida" }}
          </p>
...
export default {
  ...
  mounted() {
    ...
    script.setAttribute("repo", "1010210/TAREA2ARQUITECTURA");
